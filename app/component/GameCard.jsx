    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
      {games.map((game) => (
        <div
          ...
          className="flex flex-col bg-cover h-30 md:h-48 rounded-2xl p-2 justify-end gap-0.5 shadow-md shadow-gray-700 transition-all duration-300 ease-out hover:scale-105 hover:[&>form]:bg-amber-500 hover:[&>form]:text-white"
        >
